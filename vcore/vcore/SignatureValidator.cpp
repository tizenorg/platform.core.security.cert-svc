...
std::string SignatureValidator::Impl::errorToString(VCerr code)
{
	...
	case E_SIG_INVALID_SIG:    return "Invalid signature. Signature is invalid or some file is changed after application signed.";
	case E_SIG_INVALID_REF:    return "Invalid object reference in signature. Unknown file exists which isn't listed up in signature xml.";
