...
#define	CERT_FILE_ROOT_CA        "/usr/share/cert-svc/tests/orig_c/data/caflag/root_ca.der"
#define	CERT_FILE_SECOND_CA      "/usr/share/cert-svc/tests/orig_c/data/caflag/second_ca.der"
#define	CERT_FILE_SIGNER_AIA     "/usr/share/cert-svc/tests/orig_c/data/caflag/aia_signer.der"
#define	CERT_FILE_SIGNER_REVOKED "/usr/share/cert-svc/tests/orig_c/data/caflag/rev_signer.der"
#define	CERT_FILE_SIGNER_NOAIA   "/usr/share/cert-svc/tests/orig_c/data/caflag/noaia_signer.der"
#define	CERT_FILE_ROOT_CA_V1     "/usr/share/cert-svc/tests/orig_c/data/caflag/root_ca_v1.der"
#define	CERT_FILE_SIGNER_V1      "/usr/share/cert-svc/tests/orig_c/data/caflag/v1_signer.der"
