...
#else
    #define LogDebug(message)    DPL_MACRO_DUMMY_LOGGING(message, VcoreDPL::Log::AbstractLogProvider::LogLevel::Error)
    #define LogPedantic(message) DPL_MACRO_DUMMY_FOR_LOGGING(message, VcoreDPL::Log::AbstractLogProvider::LogLevel::Error)
#endif // BUILD_TYPE_DEBUG

#define LogInfo(message)    DPL_MACRO_FOR_LOGGING(message, VcoreDPL::Log::AbstractLogProvider::LogLevel::Error)
#define LogWarning(message) DPL_MACRO_FOR_LOGGING(message, VcoreDPL::Log::AbstractLogProvider::LogLevel::Error)
