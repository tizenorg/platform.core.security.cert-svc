 ...
 */
static int makeDataBySignature(const SignatureFileInfo &fileInfo, bool completeWithSystemCert, SignatureData &data)
{
...
SignatureValidator::Result SignatureValidator::makeIncompleteChainBySignature(
	const SignatureFileInfo &fileInfo,
	CertificateList &certList)
{
	SignatureData data;
	if (makeDataBySignature(fileInfo, false, data))
		return SIGNATURE_INVALID;
